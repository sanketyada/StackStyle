      ...
      <div className="mt-8">
        ...
        <div className="mt-12">
          ...
          <div className="flex gap-3 flex-col lg:flex-row ">
            ...
            >
              <p
                className={`min-w-3.5 h-3.5 border rounded-full ${method === "strip" ? "bg-green-400" : null} `}
              ></p>
            ...
            >
              <p
                className={`min-w-3.5 h-3.5 border rounded-full ${method === "razor" ? "bg-green-400" : null} `}
              ></p>
            ...
            >
              <p
                className={`min-w-3.5 h-3.5 border rounded-full ${method === "cod" ? "bg-green-400" : null} `}
              ></p>
